...
gulp.task('copyAddonsScripts', function () {
    ...
    var aScript7 = gulp.src(['node_modules/d3/d3.min.js'])
    ...
    var aScript75 = gulp.src(['node_modules/flot.curvedlines/curvedLines.js'])
        .pipe(gulp.dest('./vendors/flot'));
    var aScript76 = gulp.src(['node_modules/bootstrap/dist/js/bootstrap.min.js.map'])
        .pipe(gulp.dest('./vendors/js'));
    var aScript77 = gulp.src(['node_modules/progressbar.js/dist/progressbar.min.js.map'])
        .pipe(gulp.dest('./vendors/progressbar.js'));
    return merge(aScript1, aScript2, aScript3, aScript4, aScript5, aScript6, aScript7, aScript8, aScript9, aScript10, aScript11, aScript12, aScript13, aScript14, aScript15, aScript16, aScript17, aScript18, aScript19, aScript20, aScript21, aScript22, aScript23, aScript24, aScript25, aScript26, aScript27, aScript28, aScript29, aScript30, aScript31, aScript32, aScript33, aScript34, aScript35, aScript36, aScript37, aScript38, aScript39, aScript40, aScript41, aScript42, aScript43, aScript44, aScript45, aScript46, aScript47, aScript48, aScript49, aScript50, aScript51, aScript52, aScript53, aScript54, aScript55, aScript56, aScript57, aScript58, aScript59, aScript60, aScript61, aScript62, aScript63, aScript64, aScript65, aScript66, aScript67, aScript68, aScript69, aScript70, aScript71, aScript72, aScript73, aScript74, aScript75, aScript76, aScript77);
});
...
gulp.task('copyAddonsStyles', function () {
    ...
    var aStyle54 = gulp.src(['node_modules/pwstabs/assets/jquery.pwstabs.min.css'])
        .pipe(gulp.dest('./vendors/pwstabs'));
    var aStyle55 = gulp.src(['./node_modules/puse-icons-feather/feather.css'])
        .pipe(gulp.dest('./vendors/feather'));
    var aStyle56 = gulp.src(['./node_modules/puse-icons-feather/fonts/*'])
        .pipe(gulp.dest('./vendors/feather/fonts'));
    var aStyle57 = gulp.src(['./node_modules/@mdi/font/css/materialdesignicons.min.css.map'])
        .pipe(gulp.dest('./vendors/mdi/css'));
